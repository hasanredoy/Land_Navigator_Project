  ...
  return (
    ...
    <div id="slide1" className="carousel-item relative w-full    ">
     ...
     <div className=" absolute top-3 left-auto -right-1">
      <h2 className=" bg-gradient-to-r from-red-200 via-slate-200 to-purple-200 text-[#10104be6] rotate-[20deg] z-50 font-bold text-xl p-2  px-5 rounded-tr-xl rounded-bl-xl font-serif ">Best Deals!!
    </h2>
     </div>
    ...
    <div id="slide2" className="carousel-item relative w-full">
      ...
      <div className=" absolute top-3 left-auto -right-1">
      <h2 className=" bg-gradient-to-r from-red-200 via-slate-200 to-purple-200 text-[#10104be6] rotate-[20deg] z-50 font-bold text-xl p-2  px-5 rounded-tr-xl rounded-bl-xl font-serif">Best Offer!!
    </h2>
     </div>
    ...
    <div id="slide3" className="carousel-item relative w-full">
      ...
      <div className=" absolute top-3 left-auto -right-1">
      <h2 className=" bg-gradient-to-r from-red-200 via-slate-200 to-purple-200 text-[#10104be6] rotate-[20deg] z-50 font-bold text-xl p-2  px-5 rounded-tr-xl rounded-bl-xl font-serif">Offer Sell!!
    </h2>
     </div>
    ...
    <div id="slide4" className="carousel-item relative w-full">
      ...
      <div className=" absolute top-3 left-auto -right-1">
      <h2 className=" bg-gradient-to-r from-red-200 via-slate-200 to-purple-200 text-[#10104be6] rotate-[20deg] z-50 font-bold text-xl p-2  px-5 rounded-tr-xl rounded-bl-xl font-serif">Best Price!!
    </h2>
     </div>
