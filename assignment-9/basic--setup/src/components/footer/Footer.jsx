...
const Footer = () => {
  ...
  return (
    <footer className=" flex flex-col  lg:flex-row  justify-center items-center gap-y-10 lg:justify-evenly p-10 bg-neutral text-neutral-content">
      ...
      <nav className=" max-w-[200px] lg:w-full ">
        <h6 className="footer-title text-center lg:text-start">Useful Links</h6>
