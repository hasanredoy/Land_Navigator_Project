  ...
  const onSubmit = (e) => {
    ...
    setErr('')
     ...
     if(!/[A-Za-z]/.test(password)){
       setErr('Password Must Have One Uppercase Letter And One LowerCase Letter')
      return
     }
    // creating user
    ...
    .catch(err =>{
      console.log(err);
      toast.error(err?.message?err.message:"Failed To Register😔,Please Try Again")
    })
  };
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="card-body ">
          ...
          <div className="form-control relative">
            ...
            />
            {
              err==="Password Should be more than 6 Character"&&<span className=" text-red-600">{err}</span>
            }
            {
              err==="Password Must Have One Uppercase Letter And One LowerCase Letter"?<span className=" text-red-600">{err}</span>:''
            }
